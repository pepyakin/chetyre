...
pub struct RegisterBlock {
    ...
    #[doc = "0x128 - Bit counter reached bit count value specified in BC register."]
    pub events_bcmatch: EVENTS_BCMATCH,
    _reserved2: [u8; 212usize],
    #[doc = "0x200 - Shortcut for the radio."]
    pub shorts: SHORTS,
...
#[doc = "Bit counter reached bit count value specified in BC register."]
pub struct EVENTS_BCMATCH {
    register: ::vcell::VolatileCell<u32>,
}
#[doc = "Bit counter reached bit count value specified in BC register."]
pub mod events_bcmatch;
#[doc = "Shortcut for the radio."]
pub struct SHORTS {
    register: ::vcell::VolatileCell<u32>,
}
#[doc = "Shortcut for the radio."]
