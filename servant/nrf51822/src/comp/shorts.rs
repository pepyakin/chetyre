...
impl R {
    ...
    #[doc = "Bit 0 - Short-cut between READY event and SAMPLE task."]
    #[inline]
    ...
    #[doc = "Bit 1 - Short-cut between RADY event and STOP task."]
    #[inline]
    ...
    #[doc = "Bit 2 - Short-cut between DOWN event and STOP task."]
    #[inline]
    ...
    #[doc = "Bit 3 - Short-cut between UP event and STOP task."]
    #[inline]
    ...
    #[doc = "Bit 4 - Short-cut between CROSS event and STOP task."]
    #[inline]
