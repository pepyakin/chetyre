...
pub struct RegisterBlock {
    ...
    #[doc = "0x340 - Configures event enable state for each RTC event."]
    pub evten: EVTEN,
    #[doc = "0x344 - Enable events. The reading of this register gives the value of EVTEN."]
    pub evtenset: EVTENSET,
    #[doc = "0x348 - Disable events. The reading of this register gives the value of EVTEN."]
...
#[doc = "Interrupt enable clear register."]
pub mod intenclr;
#[doc = "Configures event enable state for each RTC event."]
pub struct EVTEN {
    register: ::vcell::VolatileCell<u32>,
}
#[doc = "Configures event enable state for each RTC event."]
pub mod evten;
#[doc = "Enable events. The reading of this register gives the value of EVTEN."]
pub struct EVTENSET {
    register: ::vcell::VolatileCell<u32>,
}
#[doc = "Enable events. The reading of this register gives the value of EVTEN."]
pub mod evtenset;
#[doc = "Disable events. The reading of this register gives the value of EVTEN."]
pub struct EVTENCLR {
    register: ::vcell::VolatileCell<u32>,
}
#[doc = "Disable events. The reading of this register gives the value of EVTEN."]
