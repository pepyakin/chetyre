...
impl R {
    ...
    #[doc = "Bit 17 - Reset from wake-up from OFF mode detected by the use of ANADETECT signal from WUCOMP."]
    #[inline]
    pub fn wucomp(&self) -> WUCOMPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 17 - Reset from wake-up from OFF mode detected by the use of ANADETECT signal from WUCOMP."]
    #[inline]
    pub fn wucomp(&mut self) -> _WUCOMPW {
        _WUCOMPW { w: self }
    }
    #[doc = "Bit 18 - Reset from wake-up from OFF mode detected by entering into debug interface mode."]
    #[inline]
