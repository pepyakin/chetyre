...
pub struct RegisterBlock {
    ...
    #[doc = "0x100 - WUCOMP is ready and output is valid."]
    ...
    #[doc = "0x200 - Shortcut for the WUCOMP."]
    pub shorts: SHORTS,
...
#[doc = "WUCOMP is ready and output is valid."]
