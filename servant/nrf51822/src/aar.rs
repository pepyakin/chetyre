...
pub struct RegisterBlock {
    ...
    pub addrptr: ADDRPTR,
    #[doc = "0x514 - Pointer to \"scratch\" data area used for temporary storage during resolution. A minimum of 3 bytes must be reserved."]
...
#[doc = "Pointer to the resolvable address (6 bytes)."]
pub mod addrptr;
#[doc = "Pointer to \"scratch\" data area used for temporary storage during resolution. A minimum of 3 bytes must be reserved."]
