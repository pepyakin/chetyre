...
impl PU {
    #[doc = r" Returns a pointer to the register block"]
    pub fn ptr() -> *const pu::RegisterBlock {
        1073741824 as *const _
    }
}
impl Deref for PU {
    type Target = pu::RegisterBlock;
    fn deref(&self) -> &pu::RegisterBlock {
        unsafe { &*PU::ptr() }
    }
}
#[doc = "Patch unit."]
...
#[doc = "The radio."]
pub mod radio;
#[doc = "Universal Asynchronous Receiver/Transmitter, version 1.0."]
pub struct UART0 {
    _marker: PhantomData<*const ()>,
}
...
#[doc = "Rotary decoder."]
pub mod qdec;
#[doc = "Wakeup Comparator."]
pub struct WUCOMP {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for WUCOMP {}
impl WUCOMP {
    #[doc = r" Returns a pointer to the register block"]
    pub fn ptr() -> *const wucomp::RegisterBlock {
        1073819648 as *const _
    }
}
impl Deref for WUCOMP {
    type Target = wucomp::RegisterBlock;
    fn deref(&self) -> &wucomp::RegisterBlock {
        unsafe { &*WUCOMP::ptr() }
    }
}
#[doc = "Wakeup Comparator."]
