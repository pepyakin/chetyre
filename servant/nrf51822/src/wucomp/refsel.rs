...
pub enum REFSELR {
    #[doc = "Use analog supply with a 1/8 prescaler as reference."]
    SUPPLYONEEIGHTHPRESCALING,
    #[doc = "Use analog supply with a 2/8 prescaler as reference."]
    SUPPLYTWOEIGHTHSPRESCALING,
    #[doc = "Use analog supply with a 3/8 prescaler as reference."]
    SUPPLYTHREEEIGHTHSPRESCALING,
    #[doc = "Use analog supply with a 4/8 prescaler as reference."]
    SUPPLYFOUREIGHTHSPRESCALING,
    #[doc = "Use analog supply with a 5/8 prescaler as reference."]
    SUPPLYFIVEEIGHTHSPRESCALING,
    #[doc = "Use analog supply with a 6/8 prescaler as reference."]
    SUPPLYSIXEIGHTHSPRESCALING,
    #[doc = "Use analog supply with a 7/8 prescaler as reference."]
